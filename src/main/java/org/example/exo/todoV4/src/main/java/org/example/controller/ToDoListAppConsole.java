...
import org.example.impl.CategorieDAOImpl;
...
public class ToDoListAppConsole {
    ...
    public static void main() {
        entityManagerFactory = Persistence.createEntityManagerFactory("todoV4");
        taskDAO = new TaskDAOImpl(entityManagerFactory);
        personDAO = new PersonDAOImpl(entityManagerFactory);
        categorieDAO = new CategorieDAOImpl(entityManagerFactory);
        ...
        do {
            ...
            System.out.println("8. ajout de categorie");
            System.out.println("9. Supprimer une categorie");
            System.out.println("10. afficher les taches d'une categorie");
            System.out.println("11. ajout de tache a une categorie ");
            System.out.println("12. retirer le categorie d'une tache");
    ...
    public static void  addCategorie(Scanner scanner){
        System.out.println("nom de la categorie");
        String titre = scanner.nextLine();
        Categorie categorie = new Categorie();
        categorie.setNameCategory(titre);
    ...
    private static void deleteCategory(Scanner scanner){
        System.out.println("id de la category a retirer");
        Long categoryId = scanner.nextLong();
        scanner.nextLine();

        categorieDAO.deleteCategorie(categoryId);
    ...
    public static void addCategorieTask(Scanner scanner){
        System.out.println("id de la categorie a ajouter");
        Long categorieTaskId  = scanner.nextLong();
        scanner.nextLine();
    }
}
